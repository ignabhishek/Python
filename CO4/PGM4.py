class Time:
    ...
    def __add__(self,other):
        ...
        #     hour+=int(minute/60)
        #     minute=(minute/60)
        hour = self.__hour+other.__hour+(self.__minute+other.__minute+(self.__second+other.__second)//60)//60
        minute = (self.__minute+other.__minute+(self.__second+other.__second)//60)%60
        second = (self.__second+other.__second)%60
